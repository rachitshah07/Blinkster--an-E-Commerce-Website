        ...
        if (!isset($_GET['brand'])) {
            ...
            while ($row = mysqli_fetch_assoc($result_query)) {
                ...
                <div class='card-body'>
                    ...
                    <p class='card-text'>$product_description</p>
                    <p class='card-text'>Price: $product_price/-</p>
                    <a href='index.php?add_to_cart=$product_id' class='button btn btn-primary'>Add to cart</a>
                    <a href='product_details.php?product_id=$product_id' class='btn btn-secondary'>View more</a>
                </div>
                </div>
            </div>";
        ...
        if (!isset($_GET['edit_account'])) {
            if (!isset($_GET['my_orders'])) {
                if (!isset($_GET['delete_account'])) {
                    ...
                    if ($row_count > 0) {
                        echo "<h3 class=' mt-5 mb-2 text-success text-center'> You have <span class='text-danger'> $row_count </span> pending orders. </h3> ";

                        echo "<p class='text-center' > <a href='profile.php?my_orders' class='text-dark' >Order Details</a> </p>";
                    } else {
                        echo "<h3 class=' mt-5 mb-2 text-success text-center'> You have <span class='text-danger'> Zero </span> pending orders. </h3> ";

                        echo "<p class='text-center' > <a href='../index.php' class='text-dark' >Explore products in our store</a> </p>";
                    }
                }
            }
        }
